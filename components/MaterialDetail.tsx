    ...
    <div className="p-6 bg-[#f5f5f5] min-h-full space-y-4">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
        ...
        <div className="grid grid-cols-4 gap-y-10 gap-x-6">
          ...
          <InfoItem label="提报状态" value={<span className="px-2 py-0.5 bg-blue-50 text-blue-600 rounded-full text-[10px] font-black border border-blue-100">待推送</span>} />
          ...
          <InfoItem label="商城价" value={<span className="text-red-500 font-black text-sm">{material.price.toFixed(2)}元</span>} />
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border border-slate-200">
        ...
        <div className="grid grid-cols-4 gap-6">
          ...
          <FormField label="产地" value="山东" />
          <FormField label="条形码" value="6976990718017" />
          <FormField label="尺寸规格" value="6000mm * 1000mm * 1000mm" />
          <FormField label="库存" value="999999" />
          <FormField label="别名" value={material.name} />
          <FormField label="质保时长" value="12个月" />
          <FormField label="外链URL" value={<a href="#" className="text-blue-600 hover:underline truncate inline-block w-full">https://product.suning.com/0071616335/...</a>} />
        </div>
      </div>
        ...
        <div className="p-8 flex-1">
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  {[1, 2, 3].map(i => (
                    <div key={i} className="w-28 h-28 bg-slate-50 rounded-lg border border-slate-200 p-1 group hover:border-blue-400 cursor-pointer overflow-hidden transition-all shadow-sm">
          ...
          {activeTab === 'secondary-panel' && (
             <div className="grid grid-cols-3 gap-y-8 gap-x-12 animate-in fade-in duration-300">
                ...
                <FormField label="商城状态" value="上架中" />
            ...
            <div className="flex flex-col gap-6 animate-in fade-in duration-300">
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <span className="px-3 py-1 bg-blue-50 text-blue-600 rounded-full text-[10px] font-black border border-blue-100">国铁商城</span>
                </div>
              </div>
              <div className="space-y-2">
